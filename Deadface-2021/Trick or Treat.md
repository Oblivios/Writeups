...
> (We were given the download link for the game, and the password of it)
...
print(gs()) #ANSWER (directly prints the flag)
...
I played the game for a minute and saw that when I dodged "The Death" 20 times it was going too fast
that nobody could dodge it, so we had to change the code.

I saw that the function `gs()` was called when you runned the game (as you can see on the screen below
we had "flag{" printed, and it was because of this function)

So I basically just printed/called the function `gs()` at the start of the game, which printed the flag:
